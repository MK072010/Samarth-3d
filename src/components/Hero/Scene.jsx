...
export default function Scene({ tier, reducedMotion, onTierDrop }) {
  ...
  return (
    ...
    >
      ...
      <fog attach="fog" args={['#0a0e16', 11, 25]} />
      ...
      <Suspense fallback={null}>
        <CampusModel reducedMotion={reducedMotion} tier={tier} />
        <Particles tier={tier} />
        {tier !== 'low' && (
      ...
      <CameraRig reducedMotion={reducedMotion} restPosition={[0, 1.6, 10.5]} />

      {tier === 'high' && (
        <EffectComposer multisampling={0}>
          <DepthOfField focusDistance={0.05} focalLength={0.035} bokehScale={2} height={480} />
          <Bloom intensity={0.4} luminanceThreshold={0.4} luminanceSmoothing={0.28} mipmapBlur />
