...
// Five authored shots instead of three: wide establishing view, a dolly-in
// approach, a pass along the library wing, a close approach to the entrance
// portico, and a final rising shot toward the crest. Progress scrubs
// smoothly between them so the camera move feels directed and continuous
// — deliberately not an orbit control.
const KEYFRAMES = [
  { p: 0, pos: [0, 3.6, 13], look: [0, 0.2, 0] },
  { p: 0.25, pos: [2.6, 2.2, 9], look: [0.4, 0.3, 0.4] },
  { p: 0.5, pos: [-5.4, 1.5, 6.2], look: [-2.2, 0.1, 0] },
  { p: 0.75, pos: [0, 0.7, 3.6], look: [0, 0.6, 1.6] },
  { p: 1, pos: [2.4, 1.6, 4.2], look: [0, 2.0, 0.4] },
]
